...
const FOOTBALL = ['football', '축구'];
const BASKETBALL = ['basketball', '농구'];

const FINANCE = ['finance', '금융'];
const STOCK = ['stock', '주식'];
const CRYPTO = ['crypto', '가상화폐'];
...
const LIQUOR = ['liquor', '음주'];
const PARTY = ['party', '파티'];
const TRAVEL = ['travel', '여행'];

const CULTURE = ['culture', '문화'];
const MOVIES = ['movies', '영화'];
const MUSIC = ['music', '음악'];
const BOOKS = ['books', '도서'];

const CREATIVITY = ['creativity', '창작'];
const KNITTING = ['knitting', '뜨개질'];
const CRAFTING = ['crafting', '공예'];
